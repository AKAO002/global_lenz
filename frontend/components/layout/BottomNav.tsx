  ...
  return (
    <footer className="fixed bottom-0 w-full border-t border-brand-border bg-brand-surface">
      <nav className="mx-auto flex max-w-3xl items-center justify-around px-3 py-2">
        <Link
          href="/"
          className="flex flex-col items-center rounded-xl px-2 py-1 text-xs text-brand-text transition-all duration-200 hover:scale-105 hover:bg-brand-accent-soft"
        >
